...
def runGrader(argv):
    ...
    if options.runTest != None:
        return runTest(options.runTest, moduleDict, printTestCase=options.printTestCase, display=getDisplay(True, options))
    else:
        return evaluate(options.generateSolutions, options.testRoot, moduleDict,
